...
export default function DetailsCard(){
    ...
    <div className={`relative flex flex-col max-w-lg mx-auto justify-center gap-10`}>
        <div className={`relative flex flex-col md:flex-row overflow-hidden border-[4px] border-solid border-foreground rounded-lg gap-8 md:gap-4 items-start justify-start z-30 group`}>
            <Image src={'/images/rossalanford.jpg'} alt={'image'} fill style={{objectFit: 'cover', objectPosition: '50% 10%'}} className='flex md:px-20'/>
            <div className={`relative flex flex-col bg-gradient-to-r from-background from-25% via-transparent via-55% to-background to-75% px-4 pt-2 pb-4 w-full group`}>
                <h1 className={`text-5xl text-center font-extrabold text-primary hover:text-secondary group-hover:scale-105 transition-all ease-in-out`}>ROSS ALAN FORD</h1>
                <hr className={`border-[2px] border-accent border-solid rounded-full my-2 w-full group-hover:w-5/6 mx-auto transition-all ease-in-out`}></hr>
        ...
        <div className={`flex flex-col p-4 gap-1 bg-background pt-8 overflow-hidden border-[4px] border-solid border-foreground rounded-lg group`}>
            ...
            <hr className="border-accent border-2 active:scale-110 w-full group-hover:w-4/5 my-2 transition-all ease-in-out"></hr>
