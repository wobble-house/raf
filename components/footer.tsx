...
export default function Footer(){
    return (
        <div className="z-90 w-full border-t-2 py-1 border-primary border-solid flex bottom-0 mx-auto justify-center fixed bg-gradient-radial from-zinc-900 to-background">
