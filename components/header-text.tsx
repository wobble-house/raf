export function H1({children}:{children: React.ReactNode}){
    return(
        <div className={`relative animate-softwiggle active:animate-hardwiggle group-active:animate-hardwiggle ml-4 cursor-pointer active:brightness-200 group-active:invert`}>
...
export function H3({children, position}:{children: React.ReactNode, position?: string}){
    return(
        <div className={`group-hover:animate-softwiggle group-active:animate-hardwiggle ${position == "right" ? "group-hover:mr-4":"group-hover:ml-4"} cursor-pointer`}>
